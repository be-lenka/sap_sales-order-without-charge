...
namespace BeLenka\SAP\SalesOrderWOCharge;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_SALES_ORDER_WITHOUT_CHARGE_SRV';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\SalesOrderWOCharge) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://{host}:{port}/sap/opu/odata/sap/API_SALES_ORDER_WITHOUT_CHARGE_SRV",
            ...
            [
                "url" => "https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_SALES_ORDER_WITHOUT_CHARGE_SRV",
                "description" => "No description provided",
            ]
        ];
    }
