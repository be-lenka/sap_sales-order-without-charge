...
/**
 * APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrderWOCharge
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_WITHOUT_CHARGE_SRV.A_SlsOrdWthoutChrgPartnerType-create';
    ...
    */
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonnel($personnel)
    {
        ...
        if (!is_null($personnel) && (mb_strlen($personnel) > 8)) {
            throw new \InvalidArgumentException('invalid length for $personnel when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate., must be smaller than or equal to 8.');
        }
    ...
    public function setContactPerson($contact_person)
    {
        ...
        if (!is_null($contact_person) && (mb_strlen($contact_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contact_person when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgPartnerTypeCreate., must be smaller than or equal to 10.');
        }
