...
/**
 * APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrderWOCharge
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_WITHOUT_CHARGE_SRV.A_SalesOrderWithoutChargeItemType-update';
    ...
    */
    ...
    public function setHigherLevelItem($higher_level_item)
    {
        ...
        if (!is_null($higher_level_item) && (mb_strlen($higher_level_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $higher_level_item when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSlsOrdWthoutChrgItemCategory($sls_ord_wthout_chrg_item_category)
    {
        ...
        if (!is_null($sls_ord_wthout_chrg_item_category) && (mb_strlen($sls_ord_wthout_chrg_item_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sls_ord_wthout_chrg_item_category when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrderWthoutChrgItemText($sales_order_wthout_chrg_item_text)
    {
        ...
        if (!is_null($sales_order_wthout_chrg_item_text) && (mb_strlen($sales_order_wthout_chrg_item_text) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_wthout_chrg_item_text when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if (!is_null($material) && (mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setMaterialByCustomer($material_by_customer)
    {
        ...
        if (!is_null($material_by_customer) && (mb_strlen($material_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $material_by_customer when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setRequestedQuantityUnit($requested_quantity_unit)
    {
        ...
        if (!is_null($requested_quantity_unit) && (mb_strlen($requested_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRequestedQuantitySapUnit($requested_quantity_sap_unit)
    {
        ...
        if (!is_null($requested_quantity_sap_unit) && (mb_strlen($requested_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_sap_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRequestedQuantityIsoUnit($requested_quantity_iso_unit)
    {
        ...
        if (!is_null($requested_quantity_iso_unit) && (mb_strlen($requested_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_iso_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemWeightSapUnit($item_weight_sap_unit)
    {
        ...
        if (!is_null($item_weight_sap_unit) && (mb_strlen($item_weight_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_weight_sap_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemWeightIsoUnit($item_weight_iso_unit)
    {
        ...
        if (!is_null($item_weight_iso_unit) && (mb_strlen($item_weight_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_weight_iso_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemVolumeSapUnit($item_volume_sap_unit)
    {
        ...
        if (!is_null($item_volume_sap_unit) && (mb_strlen($item_volume_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_volume_sap_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemVolumeIsoUnit($item_volume_iso_unit)
    {
        ...
        if (!is_null($item_volume_iso_unit) && (mb_strlen($item_volume_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_volume_iso_unit when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setMaterialGroup($material_group)
    {
        ...
        if (!is_null($material_group) && (mb_strlen($material_group) > 9)) {
            throw new \InvalidArgumentException('invalid length for $material_group when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 9.');
        }
    ...
    public function setMaterialPricingGroup($material_pricing_group)
    {
        ...
        if (!is_null($material_pricing_group) && (mb_strlen($material_pricing_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $material_pricing_group when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if (!is_null($plant) && (mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDateTypeRule($delivery_date_type_rule)
    {
        ...
        if (!is_null($delivery_date_type_rule) && (mb_strlen($delivery_date_type_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date_type_rule when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setSalesDocumentRjcnReason($sales_document_rjcn_reason)
    {
        ...
        if (!is_null($sales_document_rjcn_reason) && (mb_strlen($sales_document_rjcn_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sales_document_rjcn_reason when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setWbsElement($wbs_element)
    {
        ...
        if (!is_null($wbs_element) && (mb_strlen($wbs_element) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 24.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocumentItem($reference_sd_document_item)
    {
        ...
        if (!is_null($reference_sd_document_item) && (mb_strlen($reference_sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_item when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeItemTypeUpdate., must be smaller than or equal to 6.');
        }
