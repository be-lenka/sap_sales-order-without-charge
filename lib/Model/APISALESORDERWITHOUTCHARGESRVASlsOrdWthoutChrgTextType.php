<?php
/**
 * APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrderWOCharge
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_WITHOUT_CHARGE_SRV.A_SlsOrdWthoutChrgTextType';
    ...
    */
    ...
    public function setSalesOrderWithoutCharge($sales_order_without_charge)
    {
        ...
        if ((mb_strlen($sales_order_without_charge) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_without_charge when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType., must be smaller than or equal to 10.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgTextType., must be smaller than or equal to 4.');
        }
