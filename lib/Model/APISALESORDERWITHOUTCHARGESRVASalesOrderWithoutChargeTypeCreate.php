<?php
/**
 * APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrderWOCharge
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_WITHOUT_CHARGE_SRV.A_SalesOrderWithoutChargeType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_item' => '\BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToItem',
        'to_partner' => '\BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToPartner',
        'to_text' => '\BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToText'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sales_order_without_charge'] === null) {
            $invalidProperties[] = "'sales_order_without_charge' can't be null";
        }
        if ((mb_strlen($this->container['sales_order_without_charge']) > 10)) {
     ...
     *
     * @param string $sales_order_without_charge sales_order_without_charge
     *
     * @return self
     */
    public function setSalesOrderWithoutCharge($sales_order_without_charge)
    {
        ...
        if ((mb_strlen($sales_order_without_charge) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_without_charge when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderWithoutChargeType($sales_order_without_charge_type)
    {
        ...
        if (!is_null($sales_order_without_charge_type) && (mb_strlen($sales_order_without_charge_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_without_charge_type when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if (!is_null($distribution_channel) && (mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setOrganizationDivision($organization_division)
    {
        ...
        if (!is_null($organization_division) && (mb_strlen($organization_division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $organization_division when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomerPurchaseOrderType($customer_purchase_order_type)
    {
        ...
        if (!is_null($customer_purchase_order_type) && (mb_strlen($customer_purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_purchase_order_type when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocumentReason($sd_document_reason)
    {
        ...
        if (!is_null($sd_document_reason) && (mb_strlen($sd_document_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_reason when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setDeliveryDateTypeRule($delivery_date_type_rule)
    {
        ...
        if (!is_null($delivery_date_type_rule) && (mb_strlen($delivery_date_type_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date_type_rule when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderBillingBlockReason($header_billing_block_reason)
    {
        ...
        if (!is_null($header_billing_block_reason) && (mb_strlen($header_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $header_billing_block_reason when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCostCenter($cost_center)
    {
        ...
        if (!is_null($cost_center) && (mb_strlen($cost_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cost_center when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAccountingDocExternalReference($accounting_doc_external_reference)
    {
        ...
        if (!is_null($accounting_doc_external_reference) && (mb_strlen($accounting_doc_external_reference) > 16)) {
            throw new \InvalidArgumentException('invalid length for $accounting_doc_external_reference when calling APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreate., must be smaller than or equal to 16.');
        }
     ...
     * Gets to_item
     *
     * @return \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToItem|null
     */
     ...
     * Sets to_item
     *
     * @param \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToItem|null $to_item to_item
     *
     * @return self
     */
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToPartner|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToPartner|null $to_partner to_partner
     *
     * @return self
     */
     ...
     * Gets to_text
     *
     * @return \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToText|null
     */
     ...
     * Sets to_text
     *
     * @param \BeLenka\SAP\SalesOrderWOCharge\Model\APISALESORDERWITHOUTCHARGESRVASalesOrderWithoutChargeTypeCreateToText|null $to_text to_text
     *
     * @return self
     */
