<?php
/**
 * APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrderWOCharge
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_WITHOUT_CHARGE_SRV.A_SlsOrdWthoutChrgSchedLineType-create';
    ...
    */
    ...
    public function setScheduleLine($schedule_line)
    {
        ...
        if ((mb_strlen($schedule_line) > 4)) {
            throw new \InvalidArgumentException('invalid length for $schedule_line when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setOrderQuantityUnit($order_quantity_unit)
    {
        ...
        if (!is_null($order_quantity_unit) && (mb_strlen($order_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_unit when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setDelivBlockReasonForSchedLine($deliv_block_reason_for_sched_line)
    {
        ...
        if (!is_null($deliv_block_reason_for_sched_line) && (mb_strlen($deliv_block_reason_for_sched_line) > 2)) {
            throw new \InvalidArgumentException('invalid length for $deliv_block_reason_for_sched_line when calling APISALESORDERWITHOUTCHARGESRVASlsOrdWthoutChrgSchedLineTypeCreate., must be smaller than or equal to 2.');
        }
